...
final class PT extends AbstractCountry implements CountryInterface
{
    ...
    public function __construct()
    {
        ...
        $this->setName(CountryName::PORTUGAL);
        $this->setCapital(CountryCapital::LISBON);
        $this->setCode(CountryCode::PT);
        $this->setAlpha3Code('PRT');
        $this->setDialCode('+351');
        $this->setTld('.pt');
        $this->setDateFormat('d-m-Y');
        $this->setFlag(CountryFlag::PT);
        $this->setDefaultCurrency(CurrencyCode::EUR);
        $this->setDefaultTimezone(TimezoneCode::EUROPE_LISBON);
        ...
        $this->setTimezones(new Collection([
            TimezoneCode::ATLANTIC_AZORES,
            TimezoneCode::ATLANTIC_MADEIRA,
            TimezoneCode::EUROPE_LISBON,
        ]));
